      ...
      {currentDetail ? (
        <>
          ...
          <motion.div
            ...
            {currentDetail.total_mass &&
              <p className='text-xl text-black/80 font-semibold'>
                {t("Gross Weight")}:&nbsp;
                <span className='font-medium text-slate-800'>
                  {currentDetail.total_mass / 1000}kg
                </span>
              </p>
            }
        ...
        <div className='h-40 w-full flex items-center justify-center text-3xl'>
          Nothing to see
        </div>
      )}
    </section>
